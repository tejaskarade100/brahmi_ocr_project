...
_VS = {
    ...
    "i":   "\U0001103A",   # 𑀺  (i sign)
    "ii":  "\U0001103B",   # 𑀻  (ī sign)
    "u":   "\U0001103C",   # 𑀼  (u sign)
    "uu":  "\U0001103D",   # 𑀽  (ū sign)
    "r":   "\U0001103E",   # 𑀾  (ṛ sign)
    "rr":  "\U0001103F",   # 𑀿  (ṝ sign)
    "e":   "\U00011042",   # 𑁂  (e sign)
    "ai":  "\U00011043",   # 𑁃  (ai sign)
    "o":   "\U00011044",   # 𑁄  (o sign)
    "au":  "\U00011045",   # 𑁅  (au sign)
}
